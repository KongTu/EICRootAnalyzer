...
//TH2D DIS kinematics:
TH2D* Q2VsX = new TH2D("Q2VsX",";x;Q^{2}",1000,0.00001,1,200,0,200);
TH2D* W2VsFlux = new TH2D("W2VsFlux",";#Phi;W^{2}",500,0,0.1,100,0,10000);
...
TH2D* Q2VsJpsi = new TH2D("Q2VsJpsi",";p_{T};Q^{2}",100,0,10,200,0,200);
TH2D* W2VsJpsi = new TH2D("W2VsJpsi",";p_{T};W^{2}",100,0,10,100,0,10000);
...
TH2D* AngleVssNN_proton = new TH2D("AngleVssNN_proton",";s_{_{NN}} (GeV^{2});#theta (mrad)",250,0,10,300,0,30);
TH2D* AngleVssNN_neutron = new TH2D("AngleVssNN_neutron",";s_{_{NN}} (GeV^{2});#theta (mrad)",250,0,10,300,0,30);
...
TH1D* W2 = new TH1D("W2",";W^{2} (GeV^{2})", 100,0,10000);
TH1D* photonFlux = new TH1D("photonFlux",";#Phi", 500,0,0.1);
...
TH1D* EtaDist_Jpsi = new TH1D("EtaDist_Jpsi",";EtaDist_Jpsi", 200, -20,20);
...
TH1D* EtaDist_proton = new TH1D("EtaDist_proton",";EtaDist_proton", 200, -20,20);
...
TH1D* EtaDist_neutron = new TH1D("EtaDist_neutron",";EtaDist_neutron", 200, -20,20);
