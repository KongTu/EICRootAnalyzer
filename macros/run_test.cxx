...
void run_test( int nEvents, bool doBoost, TString inputFilename, TString system_name ) {
   ...
   tree->Add("../../EICTree/"+system_name+"_JpsiGeneral_EICTree/"+system_name+"_18x135_Q2_1_10_y_0.01_0.95_tau_7_noquench_kt=ptfrag=0.32_Shd1_test40k_"+inputFilename+".root" ); // Wild cards are allowed e.g. tree.Add("*.root" );
